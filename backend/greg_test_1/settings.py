"""
Django settings for greg_test_1 project.
...
WSGI_APPLICATION = 'greg_test_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "greg_test_1 API",
    "DESCRIPTION": "API documentation for greg_test_1 App",
    "VERSION": "v1",
}
